    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('medecin', 'Médecin'), ('secretaire', 'Secrétaire'), ('direction', 'Direction')], max_length=20)),
                ('code_personnel', models.CharField(blank=True, help_text='Obligatoire pour les médecins. Vide pour les autres rôles.', max_length=20, null=True, unique=True)),
                ('telephone', models.CharField(blank=True, max_length=30, null=True, validators=[django.core.validators.RegexValidator('^[0-9+ ()-]+$', 'Numéro invalide')])),
                ...
                ('licence_medicale', models.CharField(blank=True, max_length=100, null=True)),
